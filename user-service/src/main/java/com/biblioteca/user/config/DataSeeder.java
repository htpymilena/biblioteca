...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedBooks() {
        if (bookRepository.count() == 0) {
            ...
            books.add(createBookHelper("Dom Casmurro", "Machado de Assis", "9788544001813", 1899, "Livraria Garnier", Genre.ROMANCE, 256, 
            ...
            books.add(createBookHelper("Grande Sertão: Veredas", "João Guimarães Rosa", "9788520938447", 1956, "José Olympio", Genre.FICCAO, 600, 
            ...
            books.add(createBookHelper("O Alquimista", "Paulo Coelho", "9788575427583", 1988, "Rocco", Genre.FANTASIA, 172, 
            ...
            books.add(createBookHelper("Memórias Póstumas de Brás Cubas", "Machado de Assis", "9788535914849", 1881, "Typographia Nacional", Genre.ROMANCE, 304, 
            ...
            books.add(createBookHelper("Iracema", "José de Alencar", "9788508129035", 1865, "Typographia de Viana & Filhos", Genre.ROMANCE, 160, 
            ...
            books.add(createBookHelper("O Cortiço", "Aluísio Azevedo", "9788508082667", 1890, "B. L. Garnier", Genre.DRAMA, 320, 
            ...
            books.add(createBookHelper("Macunaíma", "Mário de Andrade", "9788577990444", 1928, "Oficina Gráfica Eugênio Cupolo", Genre.FICCAO, 168, 
            ...
            books.add(createBookHelper("Vidas Secas", "Graciliano Ramos", "9788501115164", 1938, "José Olympio", Genre.DRAMA, 176, 
            ...
            books.add(createBookHelper("Capitães da Areia", "Jorge Amado", "9788535914061", 1937, "José Olympio", Genre.DRAMA, 280, 
            ...
            books.add(createBookHelper("A Hora da Estrela", "Clarice Lispector", "9788532508102", 1977, "José Olympio", Genre.DRAMA, 88, 
            ...
            books.add(createBookHelper("Sagarana", "João Guimarães Rosa", "9788520938454", 1946, "Universal", Genre.FICCAO, 384, 
            ...
            books.add(createBookHelper("O Tempo e o Vento: O Continente", "Erico Verissimo", "9788535905557", 1949, "Globo", Genre.HISTORIA, 600, 
            ...
            books.add(createBookHelper("Auto da Compadecida", "Ariano Suassuna", "9788501000675", 1955, "Agir", Genre.DRAMA, 208, 
                "Peça teatral que mescla elementos da literatura de cordel, barroco e farsa popular. As trapaças de João Grilo e Chicó para enganar os poderosos do vilarejo de Taperoá culminam em um julgamento celestial presidido por Jesus e pela Virgem Maria."));

            books.add(createBookHelper("Laços de Família", "Clarice Lispector", "9788532508140", 1960, "Francisco Alves", Genre.ROMANCE, 144, 
            ...
            books.add(createBookHelper("Menino do Engenho", "José Lins do Rego", "9788501091215", 1932, "Adolfo Aizen", Genre.DRAMA, 192, 
            ...
            books.add(createBookHelper("Quincas Borba", "Machado de Assis", "9788535917451", 1891, "Typographia da Gazeta de Noticias", Genre.ROMANCE, 288, 
            ...
            books.add(createBookHelper("O Guarani", "José de Alencar", "9788508139591", 1857, "Diário do Rio de Janeiro", Genre.ROMANCE, 384, 
            ...
            books.add(createBookHelper("Triste Fim de Policarpo Quaresma", "Lima Barreto", "9788577990529", 1911, "Typographia da 'Revista dos Tribunaes'", Genre.FICCAO, 272, 
            ...
            books.add(createBookHelper("Gabriela, Cravo e Canela", "Jorge Amado", "9788535912449", 1958, "José Olympio", Genre.ROMANCE, 400, 
            ...
            books.add(createBookHelper("Mayombe", "Pepetela", "9788575037591", 1980, "União dos Escritores Angolanos", Genre.HISTORIA, 224, 
            ...
            books.add(createBookHelper("Urupês", "Monteiro Lobato", "9788525060419", 1918, "Revista do Brasil", Genre.OUTRO, 200, 
                "Coletânea de contos que introduziu a icônica figura do Jeca Tatu, o caboclo acometido pela preguiça e pelas doenças do abandono estatal. O livro expressa uma visão realista e melancólica do interior do país."));

            books.add(createBookHelper("Primeiras Estórias", "João Guimarães Rosa", "9788520938478", 1962, "José Olympio", Genre.FICCAO, 180, 
            ...
            books.add(createBookHelper("O Ateneu", "Raul Pompeia", "9788508082698", 1888, "Typographia da Gazeta de Noticias", Genre.DRAMA, 240, 
            ...
            books.add(createBookHelper("Quarto de Despejo", "Carolina Maria de Jesus", "9788508170296", 1960, "Francisco Alves", Genre.BIOGRAFIA, 200, 
            ...
            books.add(createBookHelper("Os Sertões", "Euclides da Cunha", "9788508092246", 1902, "Laemmert & C.", Genre.HISTORIA, 650, 
            ...
            books.add(createBookHelper("Esaú e Jacob", "Machado de Assis", "9788535917468", 1904, "Typographia da Gazeta de Noticias", Genre.ROMANCE, 288, 
            ...
            books.add(createBookHelper("A Moreninha", "Joaquim Manuel de Macedo", "9788508119050", 1844, "Typographia de J. E. S. Cabral", Genre.ROMANCE, 192, 
            ...
            books.add(createBookHelper("Inocência", "Visconde de Taunay", "9788508092307", 1872, "Typographia da Associação Industrial", Genre.ROMANCE, 200, 
            ...
            books.add(createBookHelper("São Bernardo", "Graciliano Ramos", "9788501115157", 1934, "Livraria Schmidt Editora", Genre.DRAMA, 200, 
            ...
            books.add(createBookHelper("Memorial de Aires", "Machado de Assis", "9788535914856", 1908, "Typographia da Gazeta de Noticias", Genre.ROMANCE, 176, 
                "O último romance de Machado. Escrito na forma do diário do Conselheiro Aires, o livro acompanha sua melancólica velhice, suas lembranças diplomáticas e as afeições paternais que desenvolve por um jovem casal de órfãos."));

            books.add(createBookHelper("Claro Enigma", "Carlos Drummond de Andrade", "9788535919059", 1951, "José Olympio", Genre.POESIA, 144, 
            ...
            books.add(createBookHelper("Morte e Vida Severina", "João Cabral de Melo Neto", "9788579020445", 1955, "José Olympio", Genre.POESIA, 120, 
            ...
            books.add(createBookHelper("Poemas Escolhidos", "Gregório de Matos", "9788535916843", 1981, "Companhia das Letras", Genre.POESIA, 220, 
            ...
            books.add(createBookHelper("Sentimento do Mundo", "Carlos Drummond de Andrade", "9788535919066", 1940, "José Olympio", Genre.POESIA, 112, 
            ...
            books.add(createBookHelper("Alguma Poesia", "Carlos Drummond de Andrade", "9788535919073", 1930, "Pimenta de Mello", Genre.POESIA, 96, 
            ...
            books.add(createBookHelper("Broquéis", "Cruz e Sousa", "9788577990666", 1893, "Typographia da 'Folha Popular'", Genre.POESIA, 100, 
            ...
            books.add(createBookHelper("Eu e Outras Poesias", "Augusto dos Anjos", "9788532508157", 1912, "Typographia de J. Valerius", Genre.POESIA, 160, 
            ...
            books.add(createBookHelper("Lira dos Vinte Anos", "Álvares de Azevedo", "9788577990413", 1853, "Typographia de J. E. S. Cabral", Genre.POESIA, 180, 
            ...
            books.add(createBookHelper("O Seminarista", "Bernardo Guimarães", "9788508119074", 1872, "Typographia do Globo", Genre.ROMANCE, 160, 
            ...
            books.add(createBookHelper("A Escrava Isaura", "Bernardo Guimarães", "9788508129042", 1875, "Casa de J. Valerius", Genre.ROMANCE, 192, 
            ...
            books.add(createBookHelper("Senhora", "José de Alencar", "9788508082728", 1875, "Typographia do Globo", Genre.ROMANCE, 288, 
            ...
            books.add(createBookHelper("Lucíola", "José de Alencar", "9788508139614", 1862, "Typographia de J. Valerius", Genre.ROMANCE, 192, 
            ...
            books.add(createBookHelper("Cinco Minutos", "José de Alencar", "9788508119098", 1856, "Typographia do Correio Mercantil", Genre.ROMANCE, 128, 
            ...
            books.add(createBookHelper("A Viuvinha", "José de Alencar", "9788508119104", 1857, "Typographia do Correio Mercantil", Genre.ROMANCE, 112, 
            ...
            books.add(createBookHelper("Helena", "Machado de Assis", "9788535914863", 1876, "Typographia de O Novo Mundo", Genre.ROMANCE, 200, 
            ...
            books.add(createBookHelper("A Mão e a Luva", "Machado de Assis", "9788535914870", 1874, "Typographia de O Novo Mundo", Genre.ROMANCE, 160, 
            ...
            books.add(createBookHelper("Ressurreição", "Machado de Assis", "9788535914887", 1872, "Typographia da Gazeta de Noticias", Genre.ROMANCE, 180, 
            ...
            books.add(createBookHelper("Casa-Grande & Senzala", "Gilberto Freyre", "9788526010093", 1933, "José Olympio", Genre.HISTORIA, 560, 
            ...
            books.add(createBookHelper("Raízes do Brasil", "Sérgio Buarque de Holanda", "9788535920444", 1936, "José Olympio", Genre.HISTORIA, 240, 
            ...
            books.add(createBookHelper("Uma Breve História do Tempo", "Stephen Hawking", "9788501072923", 1988, "Bantam Books", Genre.CIENCIA, 256, 
            ...
            log.info("50 books seeded in user-service");
        }
    }
    ...
    private void seedLoans() {
        if (loanRepository.count() == 0) {
            ...
            if (users.size() < 9 || books.size() < 50) {
                log.warn("Cannot seed loans: not enough users or books in database.");
                return;
            }
            ...
            createLoanHelper(pedro, books.get(0), today.minusDays(20), today.minusDays(6), null, LoanStatus.OVERDUE);
            createLoanHelper(pedro, books.get(1), today.minusDays(5), today.plusDays(9), null, LoanStatus.ACTIVE);

            createLoanHelper(domjoao, books.get(2), today.minusDays(30), today.minusDays(16), today.minusDays(10), LoanStatus.OVERDUE);
            createLoanHelper(domjoao, books.get(3), today.minusDays(25), today.minusDays(11), today.minusDays(11), LoanStatus.RETURNED);

            createLoanHelper(isabel, books.get(4), today.minusDays(10), today.plusDays(4), null, LoanStatus.ACTIVE);
            createLoanHelper(isabel, books.get(5), today.minusDays(30), today.minusDays(16), null, LoanStatus.OVERDUE);

            createLoanHelper(anita, books.get(6), today.minusDays(40), today.minusDays(26), null, LoanStatus.OVERDUE);
            createLoanHelper(anita, books.get(7), today.minusDays(8), today.plusDays(6), null, LoanStatus.ACTIVE);

            createLoanHelper(getulio, books.get(8), today.minusDays(50), today.minusDays(36), null, LoanStatus.OVERDUE);
            createLoanHelper(getulio, books.get(9), today.minusDays(60), today.minusDays(46), today.minusDays(44), LoanStatus.OVERDUE);

            createLoanHelper(juscelino, books.get(10), today.minusDays(4), today.plusDays(10), null, LoanStatus.ACTIVE);
            createLoanHelper(juscelino, books.get(11), today.minusDays(15), today.minusDays(1), null, LoanStatus.OVERDUE);

            createLoanHelper(gabriel, books.get(12), today.minusDays(12), today.plusDays(2), null, LoanStatus.ACTIVE);
            createLoanHelper(gabriel, books.get(13), today.minusDays(3), today.plusDays(11), null, LoanStatus.ACTIVE);
